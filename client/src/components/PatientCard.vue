<template lang="html">
  <div class="patientCard">
      ...
      <div>
          ...
          <p> You can access: </p>
          <ul>
              <li v-for="roomType in Object.keys(patient)">
                  <router-link :to="{ name: 'room', params: {roomType: roomType, patientId} }">{{patient[roomType].name}}</router-link>
              </li>
          </ul>
      </div>
  </div>
